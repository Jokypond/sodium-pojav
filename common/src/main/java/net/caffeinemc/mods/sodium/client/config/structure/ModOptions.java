...
public record ModOptions(String namespace, String name, String version, ColorTheme theme, ResourceLocation icon, boolean iconMonochrome, ImmutableList<Page> pages, List<OptionOverride> overrides) implements Searchable {
    @Override
